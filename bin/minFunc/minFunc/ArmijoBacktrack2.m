function [t,x_new,f_new,g_new,funEvals,H] = ArmijoBacktrack(...
    x,t,d,f,fr,g,gtd,c1,LS_interp,LS_multi,progTol,debug,doPlot,saveHessianComp,funObj,updateFuncObj, updateFuncParams, varargin)
...
x_new = updateFuncObj(x, t, d, updateFuncParams);
